...
extern void TInitTextTool(float scaledLeft, float scaledTop, float width, float right);
extern void TWriteTool(int x, int y);
extern void TWriteToolCommitText();
...
extern LRESULT CALLBACK TextEditProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam);